    ...
    return (
        ...
        <div>
           ...
           <h1 className="text-3xl font-extrabold tracking-tight ml-10 mt-10 text-slate-900 sm:text-4xl">
                            ...
                            Add <span className="text-green-600">Facility</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <TextField name="facilityName" isRequired>
                  ...
                  <Input placeholder="e.g. Riverside Tennis Court" className="rounded-2xl" />
              ...
              <TextField name="country" isRequired>
                ...
                <Input placeholder="e.g. Texas" className="rounded-2xl" />
