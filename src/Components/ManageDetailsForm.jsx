...
onSubmit={onSubmit}
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Price */}
              <TextField defaultValue={data?.totalPrice}  name="totalPrice" type="number" isRequired>
              ...
              <TextField defaultValue={data?.capacity} name="capacity" type="number" isRequired>
               ...
               <TextField defaultValue={data?.bookingDate}  name="bookingDate" type="date" isRequired>
                <Label>Date</Label>
                <Input
                  type="date"
